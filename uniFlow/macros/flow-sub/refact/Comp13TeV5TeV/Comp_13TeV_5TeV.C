...
// TString sMethod = "SP_scaled_noneventweighted";
TString sMethod = "SP_nonscaled_noneventweighted";

TString sHistName = "hFlow2_Charged_harm2_gap04_cent0";
TString sInput13TeV = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/multiplicity-fluctuations/pp-NchRFP-gap00-04-08-16k/gap04/output_vn_merged/"+sMethod+"/Processed.root";
TString sInput5TeV = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/multiplicity-fluctuations/pp-NchRFP-gap04-17p/gap04/output_vn_merged/"+sMethod+"/Processed.root";
TString sOutput = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/multiplicity-fluctuations/Comp_13TeV_5TeV/gap04/"+sMethod;

void Comp_13TeV_5TeV()
{
  ...
  legCent->SetHeader(sMethod.Data());
  legCent->AddEntry(hist13TeV,"pp 13 TeV","p");
  legCent->AddEntry(hist5TeV,"pp 5 TeV","p");
  ...
  canCent->SaveAs(Form("%s/pp_%s.pdf",sOutput.Data(),sMethod.Data()),"pdf");
...
TList* PrepareCanvas(TCanvas* can)
{
  ...
  padMain->Draw();
  padMain->cd();
  TH1* frame_canDiff_1 = (TH1*) gPad->DrawFrame(0.0,-0.05,10.0,1.0,Form("; p_{T} (GeV/c); v_{2}{2,|#Delta#eta|>0.4}"));
  ...
  padRatio->Draw();
  padRatio->cd();
  TH1* frame_canDiff_2 = (TH1*) gPad->DrawFrame(0.0,0.9,10.0,1.5);
