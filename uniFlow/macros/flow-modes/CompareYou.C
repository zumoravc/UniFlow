void CompareYou()
{
  ...
  for(Int_t cent(4); cent > -1; --cent)
  {
    ...
    const char* sNameMe = Form("fp2Charged_Cor3p4m2m2_gap-10_Pos_sample0_mult%d_rebin_px",cent);
    ...
    histYou->Draw("same");
    histMe->Draw("same");
    can_v422->SaveAs("/Users/vpacik/Codes/ALICE/Flow/uniFlow/results/flow-modes/cross-charged-you/15o_hi_pass1/mixed/comp_v422.pdf");
  ...
  for(Int_t cent(4); cent > -1; --cent)
  {
    ...
    const char* sNameMe = Form("fp2Charged_Cor3p4m2m2_gap10_Pos_sample0_mult%d_rebin_px",cent);
    ...
    histYou->Draw("same");
    histMe->Draw("same");
    can_v422gap10->SaveAs("/Users/vpacik/Codes/ALICE/Flow/uniFlow/results/flow-modes/cross-charged-you/15o_hi_pass1/mixed/comp_v422gap10.pdf");
  }
  ...
  for(Int_t cent(4); cent > -1; --cent)
  {
    ...
    const char* sNameMe = Form("fp2Charged_Cor3p5m2m3_gap10_Pos_sample0_mult%d_rebin_px",cent);
    ...
    histYou->Draw("same");
    histMe->Draw("same");
    can_v532gap10->SaveAs("/Users/vpacik/Codes/ALICE/Flow/uniFlow/results/flow-modes/cross-charged-you/15o_hi_pass1/mixed/comp_v532gap10.pdf");
  }
  ...
  for(Int_t cent(4); cent > -1; --cent)
  {
    ...
    const char* sNameMe = Form("fp2Charged_Cor3p6m3m3_gap10_Pos_sample0_mult%d_rebin_px",cent);
    ...
    histYou->Draw("same");
    histMe->Draw("same");
    can_v633gap10->SaveAs("/Users/vpacik/Codes/ALICE/Flow/uniFlow/results/flow-modes/cross-charged-you/15o_hi_pass1/mixed/comp_v633gap10.pdf");
  }
