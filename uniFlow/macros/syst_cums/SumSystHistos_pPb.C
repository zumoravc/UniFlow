...
void SumSystHistos_pPb(TString species = "Lambda", TString sPath = "/Users/vpacik/Codes/ALICE/Flow/uniFlow/results/cums/pPb/syst_2517/", Int_t iNumCent = 1)
{
    ...
    if(species.EqualTo("Charged")) {
        ...
        vecSyst.push_back("PVz8");
        vecSyst.push_back("TPCcls90");
        vecPID = {0.06,0.02,0.013,0.03,0.03,0.03};
        ...
        vecSyst.push_back("PVz8");
        vecSyst.push_back("TPCcls90");
        vecPID = {0.06,0.017,0.01,0.0,0.01,0.01};
        ...
        vecSyst.push_back("PVz8");
        vecSyst.push_back("TPCcls90");
        vecPID = {0.044,0.02,0.02,0.03,0.03,0.04};

    } else if(species.EqualTo("K0s")) {
        // vecSyst.push_back("CL1");
        vecSyst.push_back("PVz8");
        vecSyst.push_back("TPCcls90");
        vecSyst.push_back("V0sCPA");
        vecSyst.push_back("V0sCrossFind1");
        vecSyst.push_back("V0sDaugDCA");
        // vecSyst.push_back("V0sDaugPt02");
        vecSyst.push_back("V0sDecRad1");
        vecSyst.push_back("V0sDecRad100");
        vecSyst.push_back("V0sFinderOn");
        vecSyst.push_back("V0sPVDCA");
...
void ProcessAll()
{
    SumSystHistos_pPb("Charged");
    SumSystHistos_pPb("Pion");
    SumSystHistos_pPb("Kaon");
    SumSystHistos_pPb("Proton");
    SumSystHistos_pPb("K0s");
    SumSystHistos_pPb("Lambda");
    // SumSystHistos_pPb("Phi");
}
// ==================================================================================================================
void SetCustomPalette()
{
