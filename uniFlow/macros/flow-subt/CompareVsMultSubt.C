...
// const char* gsInputFolder = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/pPb-run2-gap0/high_pt_range/output_noweight/";
const char* gsInputFolder = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/pPb-run2-gap0/high_pt_range/output_sub/";
// const char* gsInputFolder = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/pPb-run2-gap0/output_sub_norm/";
// const char* gsInputFolder = "/Users/vpacik/NBI/Flow/uniFlow/results/flowsub/pPb-run2-gap0/high_pt_range/output_sub_norm_weighted/";
...
Double_t gdMinimum = -0.05;
Double_t gdMaximum = 0.3;

// Double_t gdMinimum = 0.;
// Double_t gdMaximum = 1.;


void CompareVsMultSubt()
{
  ...
  {
    TH1D* hTemp = (TH1D*) fInputFile->Get(Form("%s_cent%d_subt",gsHistoName,iCent));
    ...
    hTemp->GetYaxis()->SetTitle("v_{2} (sub)");
  ...
  leg->Draw();
  can->SaveAs(Form("%s/cent_dependences_subt.pdf",gsOutputFolder),"pdf");
