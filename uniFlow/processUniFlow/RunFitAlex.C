...
void RunFitAlex(const char* sOutputFilePath = "")
{
	...
	process->SetOutputFilePath("/Users/vpacik/NBI/Flow/uniFlow/testing/fitMine/");
	process->SetOutputFileName("fittingMine.root");
	...
	processAlex->SetInputFilePath("/Users/vpacik/NBI/Flow/results/uniFlow_Recon_full/CENT_woSDD_16q/");
	processAlex->SetInputFileName("AnalysisResults.root");
	processAlex->SetTaskName("UniFlow");

	processAlex->SetOutputFilePath("/Users/vpacik/NBI/Flow/uniFlow/testing/fitAlex/");
	processAlex->SetOutputFileName("fittingAlex.root");


	FlowTask* taskK0sAlex = new FlowTask("K0s_Alex",FlowTask::kK0s);
	taskK0sAlex->SetAlexFitting();
