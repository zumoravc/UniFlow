...
void RunProcessUniFlow(const char* sOutputFilePath = "")
{
	...
	process->SetInputFilePath("/Users/vpacik/NBI/Flow/results/uniFlow_syst/NUA_cor/CENT_woSDD_16q");
	...
	process->SetOutputFilePath("/Users/vpacik/NBI/Flow/results/uniFlow_syst/NUA_cor/CENT_woSDD_16q/bgFunc/");
	// process->SetOutputFilePath("/Users/vpacik/NBI/Flow/results/uniFlow_syst/Vtx_z/syst/vtx9");
	process->SetOutputFileName("UniFlow_bgFunc.root");
