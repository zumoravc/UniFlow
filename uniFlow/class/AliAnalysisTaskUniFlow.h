...
class AliAnalysisTaskUniFlow : public AliAnalysisTaskSE
{
    ...
    private:
      ...
      Bool_t                  CheckMCRecoTruth(const AliVParticle* track, const PartSpecies species) const; // check if Reco track has an associated MC particle which is the same species
