void runAnalysis()
{
    Bool_t local = kTRUE; // set if you want to run the analysis locally (kTRUE), or on grid (kFALSE)
    ...
    AliAnalysisTaskFlowPID *task = AddTaskFlowPID(); // create an instance of your analysis task
    ...
    if(local) {
        ...
        chain->Add("~/NBI/Codes/testData/2010/LHC10h/000138275/ESDs/pass2/AOD160/0012/AliAOD.root");
