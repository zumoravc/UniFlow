TString namesGap[10] = {"Refs_FMC4_harm23", "Refs_FMC4_harm24", "Refs_FMC4_harm34", "Refs_fMC6_harm223", "Refs_fMC6_harm233", "Refs_fMC6_harm234", "Refs_fMC6_harm345", "Refs_fMC8_harm2223", "Refs_fMC8_harm2233", "Refs_fMC8_harm2333"};
TString namesZM[10] = {"Refs_FMC4_harm23_2sub(0)", "Refs_FMC4_harm24_2sub(0)", "Refs_FMC4_harm34_2sub(0)", "Refs_fMC6_harm223_2sub(0)", "Refs_fMC6_harm233_2sub(0)", "Refs_fMC6_harm234_2sub(0)", "Refs_fMC6_harm345_2sub(0)", "Refs_fMC8_harm2223_2sub(0)", "Refs_fMC8_harm2233_2sub(0)", "Refs_fMC8_harm2333_2sub(0)"};
...
void FMC_comp()
{
  ...
  TGraphErrors *FMC4_harm23_YZ = new TGraphErrors((TH1D*) fileNoGap->Get(namesGap[id]));
  ...
  TGraphErrors *FMC4_harm24_YZ = new TGraphErrors((TH1D*) fileNoGap->Get(namesGap[id+1]));
  ...
  TGraphErrors *FMC4_harm34_YZ = new TGraphErrors((TH1D*) fileNoGap->Get(namesGap[id+2]));
  ...
  leg->SetNColumns(2);
  if(id == 0) {
    leg->AddEntry(FMC4_harm23,"SC (2,3) (|#Delta#eta|>0.0)","p");
    leg->AddEntry(FMC4_harm23_YZ,"SC (2,3)","p");
    leg->AddEntry(FMC4_harm24,"SC (2,4) (|#Delta#eta|>0.0)","p");
    leg->AddEntry(FMC4_harm24_YZ,"SC (2,4)","p");
    leg->AddEntry(FMC4_harm34,"SC (3,4) (|#Delta#eta|>0.0)","p");
    leg->AddEntry(FMC4_harm34_YZ,"SC (3,4)","p");
  }
  else if(id == 3) {
  ...
  if(id == 0) can->SaveAs("SC_gap.pdf");
  else if(id == 3) can->SaveAs("FMC6_gap_345.pdf");
  else can->SaveAs("FMC8_gap.pdf");
  ...
  for(int i = 0; i < max; i++)
  {
    ...
    denom = (TH1D*) fileNoGap->Get(namesGap[id+i]);
    ratio->Divide(denom);
    ratio->SetMarkerStyle(kFullSquare);
    ratio->SetMarkerColor(kBlack);
    ratio->SetLineColor(kBlack);
    ratio->SetTitle(";Centrality; with gap / no gap");
    ...
    fu1->Draw("same");
    can2[i]->SaveAs("gap_ratio_" + names[id+i]+ ".pdf");
  }
