void v22pp(){
  TFile* fileIn = TFile::Open("/home/alidock/ana/output/pp_LHC16/train_3308/processUniFlow/Processed.root","READ");
  ...
  TGraphErrors *gap00 = new TGraphErrors((TH1D*) fileIn->Get("Charged_hFlow2_harm2_gap00_cent0"));
  ...
  TGraphErrors *gap08 = new TGraphErrors((TH1D*) fileIn->Get("Charged_hFlow2_harm2_gap08_cent0"));
  ...
  TGraphErrors *gap10 = new TGraphErrors((TH1D*) fileIn->Get("Charged_hFlow2_harm2_gap10_cent0"));
  ...
  leg->SetHeader("ALICE experiment, pp @ 13TeV, LHC16d-p, h^{#pm}, |#eta| < 0.8, V0M cent: 0-1%");
